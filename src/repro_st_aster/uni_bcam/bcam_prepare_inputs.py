...
def prepare_inputs(
    ...
    superpixel_features = np.load(uni_feature_path)
    ...
    sp_i = (y_std // 16).astype(int)
    sp_j = (x_std // 16).astype(int)
    ...
    uni2_feat = superpixel_features[sp_i, sp_j, :]
...
def main() -> int:
    ...
    meta = prepare_inputs(args.matrix_h5, args.coord_csv, args.uni_feature_path, args.out_dir, args.max_cells)
    print(meta)
    return 0
